...
func runSetup(args []string) error {
	...
	fmt.Println("\nStep 5 of 5: Configure git send-email")
...
func guideCredentials(reader *bufio.Reader, launchBrowser bool) (string, error) {
	...
	fmt.Println("\nStep 1 of 5: Select a project and enable the Gmail API")
	...
	fmt.Println("\nStep 2 of 5: Configure the OAuth consent screen")
	...
	fmt.Println("  4. Under Data Access, add the Gmail API scope:")
	fmt.Println("     https://www.googleapis.com/auth/gmail.send")
	fmt.Println("  5. For an External app in Testing, add your Gmail address under")
	fmt.Println("     Audience > Test users.")
	...
	if _, err := readLine(reader, "Press Enter after the consent screen and audience are configured..."); err != nil {
		return "", err
	}

	fmt.Println("\nStep 3 of 5: Create and download an OAuth client")
